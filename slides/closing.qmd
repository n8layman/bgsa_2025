...
![](/assets/img/transferable.png){width=70% fig-align="center"}
...
:::: {layout="[[-1], [1], [-1]]" .center}
|     AI is a tool to help people answer questions, but we are the people who [ask]{style="color:red;"} questions. 
:::: 
